                ...
                Column(
                  children: [
                    SizedBox(
                      height: 70,
                      width: 75,
                      child: Image.asset('assets/images/con 1.png'),
                    ),
                ...
                Column(
                  children: [
                    SizedBox(
                      height: 70,
                      width: 75,
                      child: Image.asset('assets/images/convenience 1 (1).png'),
                    ),
                ...
                Column(
                  children: [
                    SizedBox(
                      height: 70,
                      width: 75,
                      child: Image.asset('assets/images/convenience 1 (2).png'),
                    ),
                    const Text('Chinese'),
                  ],
                ),
                Column(
                  children: [
                    SizedBox(
                      height: 70,
                      width: 75,
                      child: Image.asset('assets/images/convenience 1 (3).png'),
                    ),
                    const Text('French'),
                  ],
                ),
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: Image.asset(
                              'assets/images/c5fa3746-f113-441e-86eb-04a15d503e2a 1.png',
                              fit: BoxFit.cover,
                              width: double.infinity,
                              height: 150,
                            ),
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: Image.asset(
                              'assets/images/bd77a51f-4d0f-4e82-af98-e01656a28e8b 1.png',
                              fit: BoxFit.cover,
                              width: double.infinity,
                              height: 150,
                            ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text(
          'New',
          style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Color(0xFF06C167)),
        ),
